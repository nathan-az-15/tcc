...
<head>
  <meta charset="utf-8">
  <title>Teste de níveis ADM | Reforço+</title>
  ...
  <div class="conteudo">
    ...
    <section class='flexbox'>
      ...
      <div class="container1" style="width: 350px; height: 220px; margin-left: 2%; margin-right: 2%; margin-top: 8%; margin-bottom: 5%;">
        <a href="includequestoes.php?materia=<?= $materia?>&ano=1" style="text-decoration: none">
          <div class="hoverdiv">
            
            <p> Selecione este card para cadastrar questões referentes ao 1º ano </p>
          </div>
        </a>
      </div>

      <div class="container2" style="width: 350px; height: 220px; margin-left: 2%; margin-right: 2%; margin-top: 8%; margin-bottom: 5%;">
        <a href="includequestoes.php?materia=<?= $materia?>&ano=2" style="text-decoration: none">
          <div class="hoverdiv">
            
            <p> Selecione este card para cadastrar questões referentes ao 2º ano </p>
          </div>
        </a>
      </div>

      <div class="container3" style="width: 350px; height: 220px; margin-left: 2%; margin-right: 2%; margin-top: 8%; margin-bottom: 5%;">
        <a href="includequestoes.php?materia=<?= $materia?>&ano=3" style="text-decoration: none">
          <div class="hoverdiv">
            
            <p>Selecione este card para cadastrar questões referentes ao 3º ano </p>
          </div>
        </a>
      </div>
